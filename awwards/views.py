...
def home(request):
    ...
    return render(request,"awwards/index.html",{"all_images":all_projects})
...
def new_project(request):
    ...
    if request.method == 'POST':
        ...
        form = ProjectForm()
    return render(request,"awwards/new_project.html",{"form":form})
...
def project_review(request,project_id):
    try:
        ...
        raise Http404()
    return render(request,'awwards/review.html',{"vote_form":vote_form,"single_project":single_project,"average_score":average_score})
